...
// defiWNECSymbol is the symbol used for wrapped NEC tokens.
const defiWNECSymbol = "WNEC"
...
// CanWrapNEC signals if the token can be used to wrap native NEC
// to get some amount of it.
func (dt *DefiToken) CanWrapNEC() bool {
	return dt.Symbol == defiWNECSymbol
}
