...
// CurrentEpoch resolves the id of the current epoch of the Ncogearthchain blockchain.
...
// StakersNum resolves the number of stakers in Ncogearthchain blockchain.
