...
var SfcTokenizerMetaData = "[{\"constant\":false,\"inputs\":[{\"internalType\":\"address\",\"name\":\"addr\",\"type\":\"address\"}],\"name\":\"_updateSNECTokenAddress\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"internalType\":\"address\",\"name\":\"sender\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"stakerID\",\"type\":\"uint256\"}],\"name\":\"allowedToWithdrawStake\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"internalType\":\"address\",\"name\":\"sender\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"stakerID\",\"type\":\"uint256\"}],\"name\":\"checkAllowedToWithdrawStake\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"stakerID\",\"type\":\"uint256\"},{\"internalType\":\"uint256\",\"name\":\"amount\",\"type\":\"uint256\"}],\"name\":\"redeemSNEC\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"name\":\"outstandingSNEC\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"sNECTokenAddress\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[],\"name\":\"renounceOwnership\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[],\"name\":\"initialize\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"owner\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"isOwner\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"toStakerID\",\"type\":\"uint256\"}],\"name\":\"mintSNEC\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"internalType\":\"address\",\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"transferOwnership\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"previousOwner\",\"type\":\"address\"},{\"indexed\":true,\"internalType\":\"address\",\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"OwnershipTransferred\",\"type\":\"event\"}]"

// SfcTokenizerABI is the input ABI used to generate the binding from.
// Deprecated: Use SfcTokenizerMetaData instead.
var SfcTokenizerABI = SfcTokenizerMetaData
...
// OutstandingSNEC is a free data retrieval call binding the contract method 0x5b04f4c8.
//
// Solidity: function outstandingSNEC(address , uint256 ) view returns(uint256)
func (_SfcTokenizer *SfcTokenizerCaller) OutstandingSNEC(opts *bind.CallOpts, arg0 common.Address, arg1 *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _SfcTokenizer.contract.Call(opts, &out, "outstandingSNEC", arg0, arg1)
...
//
// Solidity: function outstandingSNEC(address , uint256 ) view returns(uint256)
func (_SfcTokenizer *SfcTokenizerSession) OutstandingSNEC(arg0 common.Address, arg1 *big.Int) (*big.Int, error) {
	return _SfcTokenizer.Contract.OutstandingSNEC(&_SfcTokenizer.CallOpts, arg0, arg1)
}

// OutstandingSNEC is a free data retrieval call binding the contract method 0x5b04f4c8.
//
// Solidity: function outstandingSNEC(address , uint256 ) view returns(uint256)
func (_SfcTokenizer *SfcTokenizerCallerSession) OutstandingSNEC(arg0 common.Address, arg1 *big.Int) (*big.Int, error) {
	return _SfcTokenizer.Contract.OutstandingSNEC(&_SfcTokenizer.CallOpts, arg0, arg1)
}
...
// SNECTokenAddress is a free data retrieval call binding the contract method 0x693c5e24.
//
// Solidity: function sNECTokenAddress() view returns(address)
func (_SfcTokenizer *SfcTokenizerCaller) SNECTokenAddress(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _SfcTokenizer.contract.Call(opts, &out, "sNECTokenAddress")
...
//
// Solidity: function sNECTokenAddress() view returns(address)
func (_SfcTokenizer *SfcTokenizerSession) SNECTokenAddress() (common.Address, error) {
	return _SfcTokenizer.Contract.SNECTokenAddress(&_SfcTokenizer.CallOpts)
}

// SNECTokenAddress is a free data retrieval call binding the contract method 0x693c5e24.
//
// Solidity: function sNECTokenAddress() view returns(address)
func (_SfcTokenizer *SfcTokenizerCallerSession) SNECTokenAddress() (common.Address, error) {
	return _SfcTokenizer.Contract.SNECTokenAddress(&_SfcTokenizer.CallOpts)
}

// UpdateSNECTokenAddress is a paid mutator transaction binding the contract method 0x06f03e22.
//
// Solidity: function _updateSNECTokenAddress(address addr) returns()
func (_SfcTokenizer *SfcTokenizerTransactor) UpdateSNECTokenAddress(opts *bind.TransactOpts, addr common.Address) (*types.Transaction, error) {
	return _SfcTokenizer.contract.Transact(opts, "_updateSNECTokenAddress", addr)
}

// UpdateSNECTokenAddress is a paid mutator transaction binding the contract method 0x06f03e22.
//
// Solidity: function _updateSNECTokenAddress(address addr) returns()
func (_SfcTokenizer *SfcTokenizerSession) UpdateSNECTokenAddress(addr common.Address) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.UpdateSNECTokenAddress(&_SfcTokenizer.TransactOpts, addr)
}

// UpdateSNECTokenAddress is a paid mutator transaction binding the contract method 0x06f03e22.
//
// Solidity: function _updateSNECTokenAddress(address addr) returns()
func (_SfcTokenizer *SfcTokenizerTransactorSession) UpdateSNECTokenAddress(addr common.Address) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.UpdateSNECTokenAddress(&_SfcTokenizer.TransactOpts, addr)
}
...
// MintSNEC is a paid mutator transaction binding the contract method 0xca2d6fd8.
//
// Solidity: function mintSNEC(uint256 toStakerID) returns()
func (_SfcTokenizer *SfcTokenizerTransactor) MintSNEC(opts *bind.TransactOpts, toStakerID *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.contract.Transact(opts, "mintSNEC", toStakerID)
}

// MintSNEC is a paid mutator transaction binding the contract method 0xca2d6fd8.
//
// Solidity: function mintSNEC(uint256 toStakerID) returns()
func (_SfcTokenizer *SfcTokenizerSession) MintSNEC(toStakerID *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.MintSNEC(&_SfcTokenizer.TransactOpts, toStakerID)
}

// MintSNEC is a paid mutator transaction binding the contract method 0xca2d6fd8.
//
// Solidity: function mintSNEC(uint256 toStakerID) returns()
func (_SfcTokenizer *SfcTokenizerTransactorSession) MintSNEC(toStakerID *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.MintSNEC(&_SfcTokenizer.TransactOpts, toStakerID)
}

// RedeemSNEC is a paid mutator transaction binding the contract method 0x4a37ec9d.
//
// Solidity: function redeemSNEC(uint256 stakerID, uint256 amount) returns()
func (_SfcTokenizer *SfcTokenizerTransactor) RedeemSNEC(opts *bind.TransactOpts, stakerID *big.Int, amount *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.contract.Transact(opts, "redeemSNEC", stakerID, amount)
}

// RedeemSNEC is a paid mutator transaction binding the contract method 0x4a37ec9d.
//
// Solidity: function redeemSNEC(uint256 stakerID, uint256 amount) returns()
func (_SfcTokenizer *SfcTokenizerSession) RedeemSNEC(stakerID *big.Int, amount *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.RedeemSNEC(&_SfcTokenizer.TransactOpts, stakerID, amount)
}

// RedeemSNEC is a paid mutator transaction binding the contract method 0x4a37ec9d.
//
// Solidity: function redeemSNEC(uint256 stakerID, uint256 amount) returns()
func (_SfcTokenizer *SfcTokenizerTransactorSession) RedeemSNEC(stakerID *big.Int, amount *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.RedeemSNEC(&_SfcTokenizer.TransactOpts, stakerID, amount)
}
