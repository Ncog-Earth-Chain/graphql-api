...
func (nec *NecBridge) MustBlockHeight() *big.Int {
	var val hexutil.Big
	if err := nec.rpc.Call(&val, "eth_blockNumber"); err != nil {
...
func (nec *NecBridge) BlockHeight() (*hexutil.Big, error) {
	...
	err := nec.rpc.Call(&height, "eth_blockNumber")
	if err != nil {
...
func (nec *NecBridge) Block(numTag *string) (*types.Block, error) {
	...
	err := nec.rpc.Call(&block, "eth_getBlockByNumber", numTag, false)
	if err != nil {
...
func (nec *NecBridge) BlockByHash(hash *string) (*types.Block, error) {
	...
	// call for data
	var block types.Block
	err := nec.rpc.Call(&block, "eth_getBlockByHash", hash, false)
	if err != nil {
		nec.log.Error("block could not be extracted")
		return nil, err
	}
