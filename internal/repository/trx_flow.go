...
// TrxFlowVolumePost resolves the list of daily trx flow aggregations.
...
// TrxFlowSpeedPost provides speed of transaction per second for the last <sec> seconds.
...
// TrxGasSpeedPost provides speed of gas consumption per second by transactions.
...
// TrxFlowUpdatePost executes the trx flow update in the database.
