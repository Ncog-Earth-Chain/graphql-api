...
func (p *proxy) getAccountPost(addr *common.Address) (*types.Account, error) {
...
func (p *proxy) AccountTransactionsPost(addr *common.Address, rec *common.Address, cursor *string, count int32) (*types.TransactionList, error) {
