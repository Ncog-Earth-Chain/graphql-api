...
func TestDefaultsReachTheirStructFields(t *testing.T) {
	...
	cases := []struct {
		...
		{"Pg.Url", keyPgUrl, func() interface{} { return cfg.Pg.Url }},
		{"Pg.MaxConns", keyPgMaxConns, func() interface{} { return cfg.Pg.MaxConns }},
		{"Pg.MinConns", keyPgMinConns, func() interface{} { return cfg.Pg.MinConns }},
		{"Pg.StatementTimeout", keyPgStatementTimeout, func() interface{} { return cfg.Pg.StatementTimeout }},
	}
...
func TestConfigKeysMatchStructPaths(t *testing.T) {
	...
	keys := map[string]string{
		...
		"keyPgUrl":                 keyPgUrl,
		"keyPgMaxConns":            keyPgMaxConns,
		"keyPgMinConns":            keyPgMinConns,
		"keyPgStatementTimeout":    keyPgStatementTimeout,
		"keyPgAutoMigrate":         keyPgAutoMigrate,
	}
